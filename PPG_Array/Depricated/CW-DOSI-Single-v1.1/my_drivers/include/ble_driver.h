...
#define NUS_PACKET_SIZE					MAX86141_PACKET_SIZE_BYTES
#define MAX86141_PACKET_SIZE_BYTES		240
...
#define DEVICE_NAME                     "AS7343 Color Sensor"     		            /**< Name of device. Will be included in the advertising data. */
