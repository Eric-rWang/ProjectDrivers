...
#define MAX86141_FIFO_SAMPLES			16//MAX86141_PACKET_SIZE_BYTES / 3		//3 bytes per sample
...
#define MAX86141_NUM_WAVELENGTHS		1
#define MAX86141_NUM_POSITIONS			8
#define MAX86141_SAMPLES_TO_CALIBRATE	75
#define MAX86141_CALIBRATION_THRESHOLD	0x05
...
/*
 *@brief Function to start the LED brightness calibration
 */
void max86141_start_led_calibration(void);

/*
 *@brief Function to accumulate calibration samples. This will calculate if the 
 *		 LEDs are too bright if by observing if there is saturation.
 */
void max86141_calibrate_samples(uint8_t* samples, uint8_t size);

/*
 *@brief Function to stop MAX86141 sampling.
 */
void max86141_shutdown(void);

/*
 *@brief Function to start MAX86141 sampling.
 */
