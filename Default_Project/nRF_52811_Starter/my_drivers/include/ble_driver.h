...
#define NUS_PACKET_SIZE					144
#define MAX86141_PACKET_SIZE_BYTES		144
...
#define DEVICE_NAME                     "Optical Array V3.2"     		            /**< Name of device. Will be included in the advertising data. */
